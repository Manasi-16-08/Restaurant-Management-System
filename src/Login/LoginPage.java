...
public class LoginPage extends ExceptionClass {
    ...
    LoginPage() {
        ...
        ImageIcon background_image = new ImageIcon(
                "C:/Users/Tejas/Desktop/Restaurant_Management_System/src/Login/bg.jpg");
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                try {
                    BufferedReader b = new BufferedReader(
                            new FileReader("C:/Users/Tejas/Desktop/Restaurant_Management_System/src/Login/home.jpg"));
                    while ((str = b.readLine()) != null) {
                        ...
                        // if (!a[0].equals(s1)) {
                        // throw new ExceptionClass("ID does not exist, Please register yourself
                        // first!"); }
                    }
                    if (flag == 0) {
    ...
    public static void remove(int ID) {
        try {
            String filePath = "C:/Users/Tejas/Desktop/Restaurant_Management_System/src/Login/idPass.txt";
            File file = new File(filePath);
            File tempFile = new File("C:/Users/Tejas/Desktop/Restaurant_Management_System/src/Login/temp.txt");
